...
BEGIN {	FS = ","
	...
	Heading="Ski Trips Average and Totals"
	print "<html>\n<head>\n<title>"Title"</title></head>\n<body>\n<h1>"Heading"</h1><table border=0><tr><th>No.</tn><th>Location</th><th>Flights</th><th>Trans</th><th>Accom</th><th>Skipass</th><th>SkiPack</th><th>Total</th></tr>\n";
}
{	sum = $2 + $3 + $4 + $5 + $6;
